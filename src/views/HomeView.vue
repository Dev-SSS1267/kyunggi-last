...
<template>
  ...
  <div class="absolute bottom-0 z-20 w-full py-4 flex justify-center">
    <div
      ...
      <object data="https://cdn.lunaiz.com/lunaiz_assets/eduflow-d.svg" alt="lunaiz" class="w-[6rem] md:w-[9rem] mx-auto" />
    </div>
  </div>
</template>

<style>
/* 화면이 작을 때는 세로 배치, 화면이 클 때는 가로 배치를 적용하는 Tailwind CSS 설정 */
</style>
